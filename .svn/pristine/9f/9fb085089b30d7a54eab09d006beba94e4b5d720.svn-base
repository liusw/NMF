...
//	private static LocalFileListener configFileListener = new LocalFileListener();
//	private static GlobalFileListener globalFileListener = new GlobalFileListener();
//	private static GZipFileListener gzipFileListener = new GZipFileListener();
//	private static BPIDFileListener bpidFileListener = new BPIDFileListener();
//	private static HTableFileListener htableFileListener = new HTableFileListener();
//	private static SidFileListener sidFileListener = new SidFileListener();
//	private static SplitTableFileListener splitTableFileListener = new SplitTableFileListener();
//	private static DBSplitTableFileListener dbSplitTableFileListener = new DBSplitTableFileListener();
//	private static HbrowkeyFileListener hbrowkeyFileListener = new HbrowkeyFileListener();
//	private static SQLFileListener sqlFileListener = new SQLFileListener();
//	private static HbtablesFileListener hbtablesFileListener = new HbtablesFileListener();
...
//			try {
//				super.close();
//				taskLogger.info("close hbase connection!");
//			} catch(Exception e) {
//				errorLogger.error(e.getMessage());
//			}
		}
