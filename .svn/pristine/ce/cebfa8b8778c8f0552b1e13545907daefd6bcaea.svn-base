...
<jsp:include page="/WEB-INF/jsp/common/dataMenu.jsp">
    ...
    <jsp:param name="subnav" value="today"/>
</jsp:include>
            ...
            <div class="tab-pane fade content-form main-content active in">
                <form class="form-inline" role="form">
                    ...
                    <div class="form-group " style="width: 30%">
                        <label>标题</label>
                        <input type="text" id="title" class="form-control time" style="width: 93%" placeholder="title"
                               autocomplete="off">
                    </div>
                    <div class="form-group">
                        &nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
    var table, navForm;
    $(function () {
        navForm.init({'showPlat':true,'showSid':true,'sidType':'MultiSelect',platChangeCallback: loadData
        });
        loadData();
    ...
    function loadData() {
        ...
        var params = {
            "id":"10000019|10000020",
            "dataType": "dataTable",
            "args": {
                plat: plat,sid:sid,title:title,status:status,version:version,version_lua:version_lua, table: "d_client_error_log_today"
            }
        };
        ...
        table = $("#example").DataTable({
            ...
            "fnRowCallback":function(nRow,aData,iDataIndex){
                ...
                $('td:eq(-1)',nRow).html("<button type='button' class='btn btn-primary' data-loading-text='提交中...' onclick='getDetail(\""+aData.desc_md5+"\")'>详情</button>");
            } ,
    ...
    function getDetail(desc_md5){
        window.location.href = "/clienterror/clientErrorDetail.htm?desc_md5="+desc_md5+"&type=1";
    }
</script>
</body>
</html>
