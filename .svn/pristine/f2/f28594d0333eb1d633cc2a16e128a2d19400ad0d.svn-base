...
<body>
	...
	<jsp:include page="/WEB-INF/jsp/common/dataMenu.jsp">
		...
		<jsp:param name="subnav" value="endHandRate" />
	</jsp:include>
	
	<div class="main">
	<jsp:include page="/WEB-INF/jsp/common/mainNav.jsp">
			<jsp:param name="actionName" value="成牌牌型概率" />
				...
				<div class="row">
					...
					<div class="col-xs-1">
						<div class="row">
							<div class="form-group col-xs-12">
								<label>&nbsp;</label>
								<button type="button" class="form-control btn btn-default" id="searchEndHandRate" data-loading-text="查询中...">查询</button>
							</div>
						</div>
					</div>
				</div>
			...
			<div>
				<table id="endHand" class="table table-bordered display"  cellspacing="0" width="100%">
					<thead>
						<tr>
							<th align="center">牌型</th>
							<th align="center">理论概率</th>
							<th align="center">实际概率</th>
							<th align="center">除弃牌后实际概率</th>
				...
				<div class="totalDiv"><small id="endHandTotal"></small></div>
			</div>
		</div>
	<br/><br/><br/>
...
$(function(){
	...
	initDatetimepicker();
	$("#searchEndHandRate").click(function(){
		searchEndHandRate();
	});
	var date = new Date();
	date.addDays(-1);
