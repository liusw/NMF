...
<jsp:include page="../common/sysconfigMenu.jsp">
	...
	<jsp:param name="subnav" value="feedConf" />
</jsp:include>

<div class="main">
	<jsp:include page="/WEB-INF/jsp/common/mainNav.jsp">
		<jsp:param name="actionName" value="Feed管理" />
	</jsp:include>
			      	...
			      	<div class="edit_area">
				      	<form class="form-horizontal" id="resForm">
				      		<div class="control-field">
				      	 	...
				      	 	<div class="control-field">
				      	 		<div class="field_body">
				      	 			<label class="field_label" for="inputName">名称:</label>
				             		<div class="mf_field_input">
...
$(document).ready(function() {
	...
	table = $('#example').DataTable({
		 ...
		 "processing": true,
	     "sServerMethod": "POST",
	     "sAjaxSource" : "config/feedConf/getData.htm",
	     "bServerSide" : true,
	     "bSort": false,
    ...
    $.ajax({
        ...
        success: function (backdata) {
            if (!backdata.error) {
                ...
                $("#myModal").modal("hide");
                resetFrom();
                table.ajax.url("config/feedConf/getData.htm").load();
            } else{
