...
<script type="text/javascript">
	...
	$(function(){
		getGamecoinsStreamTableParam(index);
	});
	
	var hashMap;
	function getGamecoinsStreamTableParam(_index){
		hashMap=new HashMap();
		...
		if(distinctType.val()==1 || distinctType.val()==2|| distinctType.val()==5){
			html='<div class="form-group myrow">'+
						...
						'<label class="checkbox-inline"><input type="checkbox" asName="c2" name="g___s___act_num___act_num#4#0" value="1"  title="赢金币" onclick="setVal(this,\'c\')">赢金币(发放)</label>&nbsp;&nbsp;&nbsp;&nbsp;'+
						'<label class="checkbox-inline"><input type="checkbox" asName="c3" name="g___s___act_num___act_num#1#0" value="1"  title="输金币" onclick="setVal(this,\'c\')">输金币(消耗)</label>'+
					'</div>';
		}
