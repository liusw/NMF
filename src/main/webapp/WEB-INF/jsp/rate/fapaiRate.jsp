...
<body>
	...
	<jsp:include page="/WEB-INF/jsp/common/dataMenu.jsp">
		...
		<jsp:param name="subnav" value="fapaiRate" />
	</jsp:include>
	...
	<div class="main">
		<jsp:include page="/WEB-INF/jsp/common/mainNav.jsp">
			...
			<div>
				<table id="fapai" class="table table-bordered display"  cellspacing="0" width="100%">
					<thead>
						<tr>
							<th align="center">发牌概率</th>
				...
				<div class="totalDiv"><small id="fapaiTotal"></small></div>
			</div>
