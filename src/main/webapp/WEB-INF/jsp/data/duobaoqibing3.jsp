...
<body>
	<jsp:include page="/WEB-INF/jsp/common/top.jsp">
       <jsp:param name="nav" value="data" />
		...
		<jsp:param name="subnav" value="duobaoqibing3" />
	</jsp:include>
	...
	<div class="main">
		...
		<div class="content-body">
			<table id="example" class="table table-striped table-bordered display dtable">
				<thead>
					<tr>
						<th></th><th>日期</th><th>每日下注人数</th><th>每日下注总次数</th><th>系统坐庄每日盈亏</th><th>玩家坐庄每日盈亏</th><th>闲家下注总金额</th>
	...
	$(function() {
		var std = new Date();
		std.addDays(-1);
		navForm = navForm.init({'showPlat':true,'showSid':true,'sidType':'MultiSelect','showDate':{'isShow':true,'startDate':std.format('yyyyMMdd'),'endDate':std.format('yyyyMMdd'),applyClickCallBack:getTable},platChangeCallback:getTable,
			'showBtn':true,'showExportBtn':false
		});
	...
	function getTable(){
		...
		var params ={
			...
			args:{
				plat:$("#navPlat").val(),etm:end,stm:start,bpid:bpid,table:"d_duobaoqibing2_1"
			}
		};
		var pa={"params":"1"};
		table = $("#example").DataTable({
		     ...
		     "bProcessing" : false,
		     "sServerMethod": "POST",
		     "sAjaxSource" : "data/common/mysqlQuery.htm",
	...
	function showDetail(o){
		...
		if ( row.child.isShown() ) {
			...
			var params ={
				id:"12000015",args:{plat:row.data().plat,tm:row.data().tm,bpid:bpid,table:"d_duobaoqibing2_1"}
			};
